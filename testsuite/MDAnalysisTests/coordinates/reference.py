...
class RefTRZ(object):
    ...
    ref_dimensions = np.array(
        [55.422830581665039, 55.422830581665039, 55.422830581665039, 90.0, 90.0, 90.0],
        dtype=np.float32,
    )
...
class RefLAMMPSData(object):
    ...
    vel_atom1 = np.array(
        [-0.005667593, 0.00791380978, -0.00300779533], dtype=np.float32
    )
    dimensions = np.array(
        [55.42282867, 55.42282867, 55.42282867, 90.0, 90.0, 90.0], dtype=np.float32
    )
...
class RefLAMMPSDataDCD(object):
    ...
    mean_dimensions = np.array(
        [50.66186142, 47.18824387, 52.33762741, 90.0, 90.0, 90.0], dtype=np.float32
    )
