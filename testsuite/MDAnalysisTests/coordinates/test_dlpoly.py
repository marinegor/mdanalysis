...
class _DLHistory(object):
    ...
    def test_position(self, u):
        ref = np.array(
            [
                [-7.595541651, -7.898808509, -7.861763110],
    ...
    def test_velocity(self, u):
        ref = np.array(
            [
                [1.109901682, -1.500264697, 4.752251711],
    ...
    def test_unitcell(self, u):
        ref1 = np.array(
            [
                [18.6796195135, 0.0000058913, -0.0000139999],
        ...
        ref2 = np.array(
            [
                [17.2277221163, -0.0044216126, -0.0003229237],
        ...
        ref3 = np.array(
            [
                [16.5435673205, -0.0108424742, 0.0014935464],
