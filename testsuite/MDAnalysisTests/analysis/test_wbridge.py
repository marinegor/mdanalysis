 ...
 13
   ...
   10.0   10.0   10.0"""
    ...
    def test_nodata(self, universe_DA):
        ...
        wb = WaterBridgeAnalysis(
            universe_DA, "protein and (resid 1)", "protein and (resid 4)", order=0
        )
        wb.generate_table()
    ...
    def test_empty_selection(self, universe_DA):
        ...
        wb = WaterBridgeAnalysis(
            universe_DA, "protein and (resid 9)", "protein and (resid 10)", order=0
        )
        wb.run()
    ...
    def test_loop(self, universe_loop):
        ...
        wb = WaterBridgeAnalysis(
            universe_loop, "protein and (resid 1)", "protein and (resid 1 or resid 4)"
        )
        wb.run()
